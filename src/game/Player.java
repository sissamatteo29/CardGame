...
public class Player implements Runnable {
    ...
    public void takeAndDiscard() {
        ...
        //The card the player is going to discard. Since the preferred cards are at the end of
        //the hand array list the card being removed is a non preferred card.
        Card discardCard = hand.remove(hand.size() - 1 - preferredCards);
        //Gives the non preferred card to the right deck.
